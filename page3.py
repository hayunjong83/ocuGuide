...
def page_info():
    ...
    step_cols[0].button('개요', on_click=set_form_step, args=['Jump', 0], type=step0_type)
    able_step_1 = True if st.session_state['progress'] < 1 else False
    step_cols[1].button('단계 1', on_click=set_form_step, args=['Jump', 1], type=step1_type, disabled=able_step_1)        
    able_step_2 = True if st.session_state['progress'] < 2 else False
    step_cols[2].button('단계 2', on_click=set_form_step, args=['Jump', 2], type=step2_type, disabled=able_step_2)
    able_step_3 = True if st.session_state['progress'] < 3 else False
    step_cols[3].button('단계 3', on_click=set_form_step, args=['Jump', 3], type=step3_type, disabled=able_step_3)     
    able_step_4 = True if st.session_state['progress'] < 4 else False
    step_cols[4].button('단계 4', on_click=set_form_step, args=['Jump', 4], type=step4_type, disabled=able_step_4)
    able_step_5 = True if st.session_state['progress'] < 5 else False
    step_cols[5].button('단계 5', on_click=set_form_step, args=['Jump', 5], type=step5_type, disabled=able_step_5)
